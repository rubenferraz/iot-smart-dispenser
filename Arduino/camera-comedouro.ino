...
//const char* ssid     = "MEO-8262C0"; // CHANGE HERE
//const char* password = "d8379bf5e2"; // CHANGE HERE
...
//const char* ssid = "Hilario";
//const char* password = "12345678";

const char* websockets_server_host = "83.212.82.121"; //CHANGE HERE
...
esp_err_t init_camera() {
  ...
  //config.frame_size = FRAMESIZE_QVGA;  // em vez de FRAMESIZE_VGA

  //config.jpeg_quality = 15; //10-63 lower number means higher quality
  config.jpeg_quality = 30;  // mais compressão, menos qualidade
  config.fb_count = 2;
